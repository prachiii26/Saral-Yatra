      ...
      <div className="w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/20 shadow-[0_32px_64px_-12px_rgba(59,130,246,0.4)] p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join Saral Yatra for smarter commuting</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              <input type="checkbox" className="mt-1 rounded border-gray-300 text-primary focus:ring-primary/20" required />
